...
public class FeatureRanking {
    ...
    private static final String DATASET = "NSL-KDD";
    private static final String ATAQUE = "app_nova";
    private static final String DIRETORIO = "C:\\Users\\sequi\\Google Drive\\2019\\Datasets\\" + DATASET + "\\" + ATAQUE + "\\";
    private static final String TRAIN_FILE = DIRETORIO + "train.txt";
    ...
    public static void main(String[] args) throws Exception {
        ...
        avaliarESelecionar(41, METODO.GR, false); // {5, 12, 7, 9, 41, 3, 13, 6, 11, 39, 8, 35, 40, 1, 36, 4, 22, 14, 21, 10, 25, }
        avaliarESelecionar(43, METODO.IG, false); // IG: 6, 2, 7, 15, 3
        avaliarESelecionar(43, METODO.OneR, false); // OneR: 6, 7, 2, 8, 17
    }
