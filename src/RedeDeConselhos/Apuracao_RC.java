...
//debug = true;
        if (isAttack) {
            ...
            System.out.println("NÃO ERA PRA ENTRAR AQUI");
    ...
    public void testInstance(Classifier classifier, int pos, boolean isAttack) throws Exception {
        ...
        if (isAttack) {
            ...
            double cpuLoadAtual = CpuLoad.getProcessCpuLoad();
            double memoryLoadAtual = CpuLoad.getProccessMemory();
...
//        System.out.println("TEMPO: " + getTempo());
        ...
        Resultado resultado = new Resultado(name, getVP(), getFN(), getVN(), getFP(), getTempo(), acuracia, txDec, txAFal, getCpuLoad(), getMemoryLoad());
        setVN(0);
        setFN(0);
        setVP(0);
        setFP(0);
