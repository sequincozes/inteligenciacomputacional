...
public class FeatureRanking {
    ...
    private static final String DATASET = "Substation";
    private static final String ATAQUE = "binario";
    private static final String DIRETORIO = "/home/silvio/datasets/Substation/Dataset 1: Power System Datasets/multiclass/";
    private static final String TRAIN_FILE = DIRETORIO + "data14_scenarios20and21.csv";
    private static final int TOTAL_FEATURES = 58;
...
//        avaliarESelecionar(58, METODO.GR, false); // {5, 12, 7, 9, 41, 3, 13, 6, 11, 39, 8, 35, 40, 1, 36, 4, 22, 14, 21, 10, 25, }
        avaliarESelecionar(58, METODO.GR, false); // IG: 6, 2, 7, 15, 3
//        avaliarESelecionar(5, METODO.OneR, false); // OneR: 6, 7, 2, 8, 17
    ...
    public static FeatureAvaliada[] avaliarESelecionar(int featuresSelecionar, METODO metodo, boolean debug) throws Exception {
        ...
        for (FeatureAvaliada feature : allFeatures) {
            String value = String.valueOf(feature.getValorFeature());
            System.out.println(feature.getIndiceFeature() + ";" + value.replace(".", ","));
        }
